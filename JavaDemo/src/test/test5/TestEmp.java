...
public class TestEmp {
	public static void main(String[] args) 
	{
		...
		while (iterator.hasNext()) {
			System.out.print(iterator.next() + " "); //1 1 2 3 4 //LinkedHashSet-->1 2 3 4 1
		}
		System.out.println();
		...
		while (iterator1.hasNext()) {
			System.out.print(iterator1.next() + " "); //1 1 2 3 4 //LinkedHashSet-->1 2 3 4 1  
		}
	}
}
