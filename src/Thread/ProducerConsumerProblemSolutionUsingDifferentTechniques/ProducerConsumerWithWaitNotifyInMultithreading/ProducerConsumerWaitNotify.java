package Thread.ProducerConsumerProblemSolutionUsingDifferentTechniques.ProducerConsumerWithWaitNotifyInMultithreading;
	...
	private void consume() throws InterruptedException 
	{
		synchronized (sharedQueue)
		{
			...
			while (sharedQueue.size() == 0)
			{
				...
				//System.out.println("Queue is empty "+ Thread.currentThread().getName()+ " is waiting for new element inserted by a producer, size: "+ sharedQueue.size());
				sharedQueue.wait();
			}
		}
		 ...
		 * consuming by entering below synchronized block producer can produce.
		 */
