...
public class ProblemInArray {
	...
	/*
	 * Prints all pair of integer values from given array whose sum is equal to given number. * complexity of this solution is O(n^2)
	 */
...
// Read more:
// http://javarevisited.blogspot.com/2014/08/how-to-find-all-pairs-in-array-of-integers-whose-sum-equal-given-number-java.html#ixzz3jQPKGjMR
