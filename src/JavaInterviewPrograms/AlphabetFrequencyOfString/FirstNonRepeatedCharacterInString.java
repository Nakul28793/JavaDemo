...
public class FirstNonRepeatedCharacterInString {
	...
	public static Character firstNonRepeatedCharacter(String inputString) 
	{
		...
		for (int i = 0; i < ar.length; i++) 
		{
			...
			{	
				// if map already contains this character as key, get value corresponding to key and increment it.
				map.put(ch, map.get(ch) + 1);
			}	
			else 
			{
				// put character in map with value as 1 (showing first occurrence of key in string)
				map.put(ch, 1);
			}	
